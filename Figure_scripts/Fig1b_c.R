...
##-----------------------------------------
## Fig. 1b: Histogram of MGX samples
##-----------------------------------------
load("./output/preprpreprocess/metadata_all.Rdata")
pdf('./figures/Fig1b.pdf',width = 6,height = 4.5)
ggplot(metadata,aes(x= mgx_age, fill = Country ))+geom_histogram(bins = 40)+theme_cowplot()+
...
##-----------------------------------------
## Fig. 1c: Immunochip SNP distribution
##-----------------------------------------
