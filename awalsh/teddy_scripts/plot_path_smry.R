...
bar_height <- nrow(paths_bugs_num)/4.5

ggsave(plot=paths_bar, file=paste0("./", opts$out, "/contributions_bar.png"), dpi=300, width=10, height=bar_height)
...
h_height <- nlevels(factor(df$FullName))/2.5
